...
// 2026-08-28: wonToKorExact 가 천 단위까지 표시하게 바뀌어 "5천"이 더 붙는다.
//   값(3,284,875,000원)은 그대로이고 안내문이 정확해진 것이다 — 옛 표기는 뒤 5천을 버리고 있었다.
check("안내문 금액 표기", resolveAmountCell("3284875000", "").note.indexOf("32억 8,487만 5천원") >= 0, resolveAmountCell("3284875000", "").note);
