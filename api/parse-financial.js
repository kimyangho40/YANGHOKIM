  ...
  properties: {
    ...
    is_provisional: {
      ...
      description:
        ...
        "★ 표기가 하나도 없어도, 보고기간이 회계연도 끝까지가 아니면(예: 2025-01-01~2025-10-31) " +
        "결산 전 기중 시산이므로 true. " +
...
const SYSTEM = [
  ...
  "· ★ 표기가 하나도 없어도, 보고기간이 회계연도 끝까지가 아니면 is_provisional=true 입니다.",
  "  예: '보고기간 2025-01-01 ~ 2025-10-31' → 10개월치 기중 시산이므로 true.",
  "  이런 문서는 매출원가·법인세가 아직 안 잡혀 있어 영업이익이 비정상적으로 크게 나옵니다.",
  "  period_start·period_end 를 문서에 적힌 그대로 담고, provisional_evidence 에 그 기간을 적으세요.",
